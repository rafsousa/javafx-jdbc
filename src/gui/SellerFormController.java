...
public class SellerFormController implements Initializable {
	...
	public void onBtSaveAction(ActionEvent event) {
		...
		try {
			...
			notifyDataChangeListeners(); // Atualizar o Grid depois de salvar o registro
			Utils.currentStage(event).close();
			Alerts.showAlert(null, null, "Registro salvo com sucesso", AlertType.INFORMATION);
	...
	private Seller getFormData() {
		...
		ValidationExceptions exception = new ValidationExceptions("Erro na validação.");
		...
		// Recuperar a data do componente datepicker
	...
	public void updateFormData() {
		...
		txtId.setText(String.valueOf(entity.getId()).trim());
